            ...
            <table className="table-auto w-full font-titleFont border-2">
              <thead>
                <tr>
                  ...
                  <th className="border px-4 py-2 bg-gray-200">Description</th>
                ...
                {products.map((product) => (
                  <tr key={product.id}>
                    <td className="border px-4 py-2 w-40 text-center">
                      <img
                        className="px-2 py-2 object-cover "
                        src={product.image}
                        alt="ProductImage"
                      ></img>
                    </td>
                    ...
                    <td className="border px-4 py-2 w-32 text-center">
                      <button className="bg-blue-500 text-white py-2 px-3  active:bg-blue-500 hover:bg-blue-400 rounded mr-2">
                        Edit
                      </button>
                      <button className="bg-red-500 text-white py-2 px-3  active:bg-red-500 hover:bg-red-400 rounded">
                        Delete
                      </button>
                    </td>
                  </tr>
